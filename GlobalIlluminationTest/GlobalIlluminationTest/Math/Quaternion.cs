...
namespace Common
{
    ...
    struct Quaternion
    {
        public static void Test()
        {
            ...
            Console.WriteLine("测试angle " + angle);

            Quaternion angleAxis = AngleAxis(10, dir);
            Console.WriteLine("测试angleAxis " + angleAxis);
            ...
            Console.WriteLine("测试RotateTowards " + rotateTowards);
            ...
            Console.WriteLine("测试FromToRotation " + fromToRotation);

            Quaternion inverstQua = Quaternion.Inverse(fromToRotation);
            Console.WriteLine("测试inverst " + inverstQua);

            Quaternion lerpQua = Quaternion.Lerp(rotate, rotate2, 0.5f);
            Console.WriteLine("测试lerp " + lerpQua);

            float angle2 = 0;
            Vector3 axis = Vector3.zero;
            lerpQua.ToAngleAxis(out angle2, out axis);
            Console.WriteLine("测试ToAngleAxis " + angle2 + " " + axis);
