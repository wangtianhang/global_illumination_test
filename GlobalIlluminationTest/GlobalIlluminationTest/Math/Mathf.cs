...
namespace Common
{
    ...
    public struct Mathf
    {
        ...
        {
            Console.WriteLine(IsPowerOfTwo(8).ToString());
            Console.WriteLine(IsPowerOfTwo(3).ToString());
            Console.WriteLine(ClosestPowerOfTwo(8).ToString());
            Console.WriteLine(ClosestPowerOfTwo(3).ToString());
            Console.WriteLine(ClosestPowerOfTwo(10).ToString());
        }
